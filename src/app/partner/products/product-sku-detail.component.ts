...
export class ProductSkuDetailComponent implements OnInit {
  ...
  detailsForm: ProductSkuForm = {
    skuCode: '', skuTitle: '', upc: '',
    basePrice: null, comparePrice: null, costPrice: null,
    weight: null, weightUnit: 'LB',
    length: null, width: null, height: null, dimUnit: 'IN',
    countryOrigin: '', htsCode: '',
    hazmatFlag: 'N', fulfillmentType: 'SHIP',
    isBackorderable: 'N', maxBackorderQty: null,
  ...
  private syncDetailsForm(sku: ProductSku): void {
    this.detailsForm = {
      ...
      width: sku.width,
      height: sku.height,
      dimUnit: sku.dimUnit ?? 'IN',
      countryOrigin: sku.countryOrigin ?? '',
      htsCode: sku.htsCode ?? '',
      hazmatFlag: sku.hazmatFlag,
      fulfillmentType: sku.fulfillmentType ?? 'SHIP',
      isBackorderable: sku.isBackorderable,
      maxBackorderQty: sku.maxBackorderQty,
      status: sku.status,
